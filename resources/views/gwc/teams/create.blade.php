...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.createnewteam')}}</title>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{__('adminMessage.createnewteam')}}</a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">{{__('adminMessage.createnewteam')}}</h3>
									</div>
					...
					@if(auth()->guard('admin')->user()->can('teams-create'))
                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="{{route('teams.store')}}">
										...
										<!--parent categories dropdown -->	
                                          ...
                                          <div class="form-group row">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('position_en')) is-invalid @endif" name="position_en"
                                                               value="{{old('position_en')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_position_en')}}*" />
                                                               @if($errors->has('position_en'))
                                                               <div class="invalid-feedback">{{ $errors->first('position_en') }}</div>
                                                               @endif
                                                </div>
                                                <div class="col-lg-6">
                                                <label>{{__('adminMessage.position')}}(Ar)</label>
                                                <input type="text" class="form-control @if($errors->has('position_ar')) is-invalid @endif" name="position_ar"
                                                               value="{{old('position_ar')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_position_ar')}}*" />
