...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.editcaseupdate')}}</title>
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{__('adminMessage.editcaseupdate')}}</a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">{{__('adminMessage.editcaseupdate')}}</h3>
									</div>
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<div class="kt-portlet__head-actions">
												...
												<a href="{{url('gwc/clients_cases_updates/'.$editcases->case_id)}}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-list-ul"></i>{{__('adminMessage.listcasesupdates')}}</a> @endif
											</div>
										</div>
									</div>
								</div>				
                    ...
                    <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="{{route('editCaseUpdate',$editcases->id)}}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                          <input type="hidden" name="case_id" value="{{$editcases->case_id}}">
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-2">
														<span class="kt-switch">
															<label>
																<input type="checkbox" {{ old('is_active', $editcases->is_active) ? 'checked' : '' }}  name="is_active"  id="is_active" value="1"/>
																<span></span>
															</label>
														</span>
													</div>
                                      ...
                                      <!--categories description -->          
													...
													<div data-repeater-list="attach_exist" class="col-lg-12">
                                                     @foreach($caseattachlists as $caseattachlist)
														<div  class="form-group row align-items-center">
															...
															<div class="col-md-2">
                                                            <a href="javascript:;" title="{{__('adminMessage.savechanges')}}"  class="btn-sm btn btn-label-info btn-bold updateAttachUpdateDetails" id="{{$caseattachlist->id}}">
																	<i class="la la-check-circle"></i>
																</a>
																<a href="javascript:;" data-toggle="kt-popover" data-trigger="focus" title="{{__('adminMessage.alert')}}" data-html="true" data-content="{{__('adminMessage.areyousuretodelete')}}<br><br><a href='{{url('gwc/clients_cases_updates/'.$editcases->id.'/deleteattach/'.$caseattachlist->id)}}' class='btn btn-brand btn-danger btn-icon-sm btn-sm'>YES</a>"   class="btn-sm btn btn-label-danger btn-bold">
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													...
													<button type="button" onClick="Javascript:window.location.href='{{url('gwc/clients_cases_updates/'.$editcases->case_id)}}'"  class="btn btn-secondary cancelbtn">{{__('adminMessage.cancel')}}</button>
												</div>
											</div>
										</form>
