						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                           ...
                           @endif 
							<div class="kt-portlet kt-portlet--mobile">
                                ...
                                @if(auth()->guard('admin')->user()->can('clients-case-updates-view'))
                                <div class="row">
                                <div class="col-lg-6">
                               ...
                               <div class="kt-section kt-section--space-sm "><label class="kt-font-boldest">{{__('adminMessage.created_at')}} : </label> {{$viewcases->created_at}}</div>
                                ...
                                <div class="col-lg-2"><a class="btn btn-success" href="{{url('uploads/attach/'.$caseattachlist->file_name)}}" target="_blank">@if($caseattachlist->title_en) {{$caseattachlist->title_en}} @else {{__('adminMessage.download')}}-{{$key}} @endif</a></div>
                                @endforeach
                                </div>
                                @endif
