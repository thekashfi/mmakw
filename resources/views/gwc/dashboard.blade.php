...
@endphp
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="row">
								<div class="col-lg-4">
									<a href="{{url('gwc/newsevents')}}" class="kt-portlet kt-iconbox kt-iconbox--animate-slow">
								...
								<div class="col-lg-4">
									<a href="{{url('gwc/practice')}}" class="kt-portlet kt-iconbox kt-iconbox--animate">
										<div class="kt-portlet__body">
											<div class="kt-iconbox__body">
												<div class="kt-iconbox__icon">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
								...
								<div class="col-lg-4">
									<a href="{{url('gwc/services')}}" class="kt-portlet kt-iconbox kt-iconbox--animate-fast">
										<div class="kt-portlet__body">
											<div class="kt-iconbox__body">
												<div class="kt-iconbox__icon">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                ...
                                <div class="col-lg-4">
									<a href="{{url('gwc/clients')}}" class="kt-portlet kt-iconbox kt-iconbox--animate-fast">
										<div class="kt-portlet__body">
											<div class="kt-iconbox__body">
												<div class="kt-iconbox__icon">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                ...
                                <div class="col-lg-4">
									<a href="{{url('gwc/teams')}}" class="kt-portlet kt-iconbox kt-iconbox--animate-fast">
										<div class="kt-portlet__body">
											<div class="kt-iconbox__body">
												<div class="kt-iconbox__icon">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
...
@php
$unreadcases = App\Http\Controllers\AdminDashboardController::listunreadcaseupdatesweek();
$unreadcontacts = App\Http\Controllers\AdminDashboardController::getContactsLists();
@endphp                         
                            <div class="row">
                        <div class="col-lg-6">
                        <!--begin:: Widgets/Support Tickets -->
									<div class="kt-portlet kt-portlet--height-fluid">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													{{__('adminMessage.today_case_updates')}}
												</h3>
											</div>
										</div>
										<div class="kt-portlet__body">
												...
												<div class="kt-widget3__item">
													<div class="kt-widget3__header">
														<div class="kt-widget3__user-img">
                                                            @if($unreadcase->image)
                                                            <img class="kt-widget3__img" src="{!! url('uploads/clients/thumb/'.$unreadcase->image) !!}" width="40">
                                                            @endif
														</div>
														<div class="kt-widget3__info">
															<a href="{{url('gwc/clients_cases/'.$unreadcase->case_id.'/view')}}" class="kt-widget3__username">
																{{$unreadcase->name}}
															</a><br>
                                                        ...
                                                        @if($unreadcase->is_read==1)
														<span class="kt-widget3__status kt-font-success">
															{{__('adminMessage.seen')}}
														</span>
                                                        @else
                                                        <span class="kt-widget3__status kt-font-danger">
															{{__('adminMessage.unseen')}}
														</span>
                                                        @endif
													</div>
													<div class="kt-widget3__body">
                                                        <h5>{!!$unreadcase->title_en!!}</h5>
														<p class="kt-widget3__text">
															{!!$unreadcase->details_en!!}
														</p>
													</div>
												</div>
                                             @endforeach
                        ...
                        <!--begin:: Widgets/Support Tickets -->
									<div class="kt-portlet kt-portlet--height-fluid">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													{{__('adminMessage.today_contact_message')}}
												</h3>
											</div>
										</div>
										<div class="kt-portlet__body">
												...
												<div class="kt-widget3__item">
													...
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
														...
														<div class="kt-widget3__info">
															...
															<a href="{{url('gwc/contactus/'.$unreadcontact->id.'/view')}}" class="kt-widget3__username">
																{{$unreadcontact->name}}
															</a><br>
															<span class="kt-widget3__time">
