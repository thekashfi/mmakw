...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.createnewscase')}}</title>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{__('adminMessage.createnewscase')}}</a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">{{__('adminMessage.createnewscase')}}</h3>
									</div>
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<div class="kt-portlet__head-actions">
												...
												<a href="{{url('gwc/clients_cases/'.request()->client_id)}}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-list-ul"></i>{{__('adminMessage.listcases')}}</a> @endif
											</div>
										</div>
									</div>
								</div>				
					...
					@if(auth()->guard('admin')->user()->can('clients-case-create'))
                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="{{route('createCase',request()->client_id)}}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
										...
										<!--parent categories dropdown -->	
                                           <div class="form-group row">
                                                ...
                                                <option value="{{$listCaseType->id}}" >{{$listCaseType->title_en}}</option>
                                                @endforeach
                                                </select>
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-4">
														<input type="text" class="form-control @if($errors->has('reference_number')) is-invalid @endif" name="reference_number"  value="{{old('reference_number')?old('reference_number'):''}}" autocomplete="off" />
                                            ...
                                            <!-- end attach -->
                                             <div class="kt-portlet__foot">
												<div class="kt-form__actions">
													...
													<button type="button" onClick="Javascript:window.location.href='{{url('gwc/clients_cases/'.request()->client_id)}}'"  class="btn btn-secondary cancelbtn">{{__('adminMessage.cancel')}}</button>
												</div>
											</div>
