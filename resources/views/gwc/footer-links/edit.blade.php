...
<head>
    <meta charset="utf-8"/>
    <title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.editfooterlink')}}</title>
                    ...
                    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                        <div class="kt-container  kt-container--fluid ">
                            <div class="kt-subheader__main">
                                <h3 class="kt-subheader__title">{{__('adminMessage.footer-links')}}</h3>
                                ...
                                <div class="kt-subheader__breadcrumbs">
                                    ...
                                    <a href="javascript:;"
                                       class="kt-subheader__breadcrumbs-link">{{__('adminMessage.editfooterlink')}}</a>
                                </div>
                            </div>
                        ...
                        <div class="kt-portlet">
                            <div class="kt-portlet__head kt-portlet__head--lg">
                                <div class="kt-portlet__head-label">
                                    ...
                                    <h3 class="kt-portlet__head-title">{{__('adminMessage.editfooterlink')}}</h3>
                                </div>
                                    ...
                                    <div class="kt-portlet__head-wrapper">
                                        <div class="kt-portlet__head-actions">
                                            ...
                                            @if(auth()->guard('admin')->user()->can('services-list'))
                                                <a href="{{url('gwc/footer-links')}}"
                                                   class="btn btn-brand btn-elevate btn-icon-sm"><i
                                                            class="la la-list-ul"></i>{{__('adminMessage.listfooterlinks')}}
                                                </a>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            @if(auth()->guard('admin')->user()->can('services-edit'))
                                <form name="tFrm" id="form_validation" method="post" class="kt-form"
                                      ...
                                      action="{{route('footer-links.update',$link->id)}}">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('link')) is-invalid @endif" name="link"
                                                       value="{{ old('link', $link->link) }}" autocomplete="off" placeholder="{{__('adminMessage.enter_link')}}" />
                                                @if($errors->has('link'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-3">
														<span class="kt-switch">
															<label>
																<input type="checkbox" name="is_active"  id="is_active" value="{{ old('is_active', $link->is_active) ? 'checked' : '' }}"/>
																<span></span>
															</label>
														</span>
                                                    </div>
                                                    ...
                                                    <div class="col-3">
                                                        <input type="text" class="form-control @if($errors->has('display_order')) is-invalid @endif" name="display_order"  value="{{ old('display_order', $link->display_order) }}" autocomplete="off" />
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('name_en')) is-invalid @endif" name="name_en"
                                                       value="{{old('name_en', $link->name_en)}}" autocomplete="off" placeholder="{{__('adminMessage.enter_name_en')}}" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('name_ar')) is-invalid @endif" name="name_ar"
                                                       value="{{old('name_ar', $link->name_ar)}}" autocomplete="off" placeholder="{{__('adminMessage.enter_name_ar')}}" />
                                    ...
                                    <div class="kt-portlet__foot">
                                        <div class="kt-form__actions">
                                            ...
                                            <button type="button"
                                                    onClick="Javascript:window.location.href='{{url('gwc/footer-links')}}'"
