...
<head>
    <meta charset="utf-8"/>
    <title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.editslide')}}</title>
                    ...
                    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                        <div class="kt-container  kt-container--fluid ">
                            <div class="kt-subheader__main">
                                <h3 class="kt-subheader__title">{{__('adminMessage.slides')}}</h3>
                                ...
                                <div class="kt-subheader__breadcrumbs">
                                    ...
                                    <a href="javascript:;"
                                       class="kt-subheader__breadcrumbs-link">{{__('adminMessage.editslide')}}</a>
                                </div>
                            </div>
                        ...
                        <div class="kt-portlet">
                            <div class="kt-portlet__head kt-portlet__head--lg">
                                <div class="kt-portlet__head-label">
                                    ...
                                    <h3 class="kt-portlet__head-title">{{__('adminMessage.editslide')}}</h3>
                                </div>
                                    ...
                                    <div class="kt-portlet__head-wrapper">
                                        <div class="kt-portlet__head-actions">
                                            ...
                                            @if(auth()->guard('admin')->user()->can('services-list'))
                                                <a href="{{url('gwc/slides')}}"
                                                   class="btn btn-brand btn-elevate btn-icon-sm"><i
                                                            class="la la-list-ul"></i>{{__('adminMessage.listslides')}}
                                                </a>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            @if(auth()->guard('admin')->user()->can('services-edit'))
                                <form name="tFrm" id="form_validation" method="post" class="kt-form"
                                    ...
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('link')) is-invalid @endif" name="link"
                                                       value="{{ old('link', $slide->link) }}" autocomplete="off" placeholder="{{__('adminMessage.enter_link')}}" />
                                                @if($errors->has('link'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-3">
														<span class="kt-switch">
															<label>
																<input type="checkbox" checked="checked" name="is_active"  id="is_active" value="{{ old('is_active', $slide->is_active) }}"/>
																<span></span>
															</label>
														</span>
                                                    </div>
                                                    ...
                                                    <div class="col-3">
                                                        <input type="text" class="form-control @if($errors->has('display_order')) is-invalid @endif" name="display_order"  value="{{ old('display_order', $slide->display_order) }}" autocomplete="off" />
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('title_en')) is-invalid @endif" name="title_en"
                                                       value="{{ old('title_en', $slide->title_en) }}" autocomplete="off" placeholder="{{__('adminMessage.enter_title_en')}}" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('title_ar')) is-invalid @endif" name="title_ar"
                                                       value="{{ old('title_ar', $slide->title_ar) }}" autocomplete="off" placeholder="{{__('adminMessage.enter_title_ar')}}" />
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                <label>{{__('adminMessage.sub_title_en')}}</label>
                                                <input type="text" class="form-control @if($errors->has('sub_title_en')) is-invalid @endif" name="sub_title_en"
                                                       value="{{ old('sub_title_en', $slide->sub_title_en) }}" autocomplete="off" placeholder="{{__('adminMessage.enter_sub_title_en')}}" />
                                                @if($errors->has('sub_title_en'))
                                                    <div class="invalid-feedback">{{ $errors->first('sub_title_en') }}</div>
                                                @endif
                                            </div>
                                            <div class="col-lg-6">
                                                <label>{{__('adminMessage.sub_title_ar')}}</label>
                                                <input type="text" class="form-control @if($errors->has('sub_title_ar')) is-invalid @endif" name="sub_title_ar"
                                                       value="{{ old('sub_title_ar', $slide->sub_title_ar) }}" autocomplete="off" placeholder="{{__('adminMessage.enter_sub_title_ar')}}" />
                                                @if($errors->has('sub_title_ar'))
                                                    <div class="invalid-feedback">{{ $errors->first('sub_title_ar') }}</div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2">
                                                @if($slide->image)
                                                    <img src="{!! url('uploads/slides/thumb/'.$slide->image) !!}"
                                                         width="40">
                                                    <a href="javascript:;" data-toggle="kt-popover" data-trigger="focus"
                                                       title="{{__('adminMessage.alert')}}" data-html="true"
                                                       data-content="{{__('adminMessage.areyousuretodelete')}}<br><br><a href='{{url('gwc/slides/deleteslideImage/'.$slide->id)}}' class='btn btn-brand btn-danger btn-icon-sm btn-sm'>YES</a>"
...
{{--                                                    <input type="file"--}}
{{--                                                           class="custom-file-input @if($errors->has('video')) is-invalid @endif"--}}
{{--                                                           id="video" name="video">--}}
{{--                                                    <label class="custom-file-label"--}}
{{--                                                           for="video">{{__('adminMessage.chooseVideo')}}</label>--}}
{{--                                                </div>--}}
{{--                                                @if($errors->has('video'))--}}
...
{{--                                            </div>--}}
                                            <div class="col-lg-2">
                                                @if($slide->video)
                                                    <a href="javascript:;" data-toggle="kt-popover" data-trigger="focus"
                                                       title="{{__('adminMessage.alert')}}" data-html="true"
                                                       data-content="{{__('adminMessage.areyousuretodelete')}}<br><br><a href='{{url('gwc/slides/deleteslideVideo/'.$slide->id)}}' class='btn btn-brand btn-danger btn-icon-sm btn-sm'>YES</a>"
                                                       class="btn btn-brand btn-danger btn-icon-sm btn-sm"><i
                                                                class="la la-trash"></i>{{__('adminMessage.delete')}}
                                                    </a>
                                                @endif
