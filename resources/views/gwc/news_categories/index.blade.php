...
<head>
	<base href="../../">
	<meta charset="utf-8" />
	<title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.news_categories')}}</title>
						...
						<div class="kt-container  kt-container--fluid ">
							<div class="kt-subheader__main">
								...
								<div class="kt-subheader__breadcrumbs">
									...
									<a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{__('adminMessage.newscategorieslisting')}}</a>
							...
							<div class="kt-subheader__toolbar">
								...
								<div class="btn-group">
									@if(auth()->guard('admin')->user()->can('services-create'))
										<a href="{{url('gwc/news-categories/create')}}" class="btn btn-brand btn-bold"><i class="la la-plus"></i>&nbsp;{{__('adminMessage.createnew')}}</a>
							...
							<div class="kt-portlet__head kt-portlet__head--lg">
								<div class="kt-portlet__head-label">
									...
									<h3 class="kt-portlet__head-title">
										{{__('adminMessage.newscategorieslisting')}}
									</h3>
								</div>
							</div>
											...
											@if(count($categories))
												...
												@foreach($categories as $category)
                                                 ...
                                                 @if(auth()->guard('admin')->user()->can('services-edit'))
														 <li class="kt-nav__item"><a href="{{url('gwc/news-categories/'.$category->id.'/edit')}}" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-contract"></i><span class="kt-nav__link-text">{{__('adminMessage.edit')}}</span></a></li>
													 @endif
																...
																<div class="modal-dialog" role="document">
																	<div class="modal-content">
																		...
																		<div class="modal-footer">
																			...
																			<button type="button" class="btn btn-danger"  onClick="Javascript:window.location.href='{{url('gwc/news-categories/delete/'.$category->id)}}'">{{__('adminMessage.yes')}}</button>
																		</div>
																	</div>
																</div>
															</div>
