...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.createnewbox')}}</title>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					@if(auth()->guard('admin')->user()->can('services-create'))
                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="{{route('boxes.store')}}">
											...
											<div class="form-group row">
												<div class="col-lg-6">
													...
													<input type="text" class="form-control @if($errors->has('link_title_en')) is-invalid @endif" name="link_title_en"
														   value="{{old('link_title_en')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_link_title_en')}}" />
												...
												<div class="col-lg-6">
													...
													<input type="text" class="form-control @if($errors->has('link_title_ar')) is-invalid @endif" name="link_title_ar"
														   value="{{old('link_title_ar')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_link_title_ar')}}" />
                                         ...
                                         <div class="form-group row">
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													...
													<button type="button" onClick="Javascript:window.location.href='{{url('gwc/boxes')}}'"  class="btn btn-secondary cancelbtn">{{__('adminMessage.cancel')}}</button>
												</div>
											</div>
										</div>
									</form>
