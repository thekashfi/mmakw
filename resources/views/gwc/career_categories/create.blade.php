...
<head>
	<meta charset="utf-8" />
	<title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.createnewcareercategory')}}</title>
						...
						<div class="kt-container  kt-container--fluid ">
							<div class="kt-subheader__main">
								...
								<div class="kt-subheader__breadcrumbs">
									...
									<a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{__('adminMessage.createnewcareercategory')}}</a>
								</div>
							</div>
						...
						<div class="kt-portlet">
							<div class="kt-portlet__head kt-portlet__head--lg">
								<div class="kt-portlet__head-label">
									...
									<h3 class="kt-portlet__head-title">{{__('adminMessage.createnewcareercategories')}}</h3>
								</div>
									...
									<div class="kt-portlet__head-wrapper">
										<div class="kt-portlet__head-actions">
											...
											@if(auth()->guard('admin')->user()->can('services-list'))
												<a href="{{url('gwc/career-categories')}}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-list-ul"></i>{{__('adminMessage.listcareercategories')}}</a> @endif
										</div>
									</div>
								</div>
							</div>
							...
							@if(auth()->guard('admin')->user()->can('services-create'))
								...
								<form name="tFrm"  id="form_validation"  method="post"
									  class="kt-form" enctype="multipart/form-data" action="{{url('gwc/career-categories')}}">
									...
									<div class="kt-portlet__foot">
										<div class="kt-form__actions">
											...
											<button type="button" onClick="Javascript:window.location.href='{{url('gwc/career-categories')}}'"  class="btn btn-secondary cancelbtn">{{__('adminMessage.cancel')}}</button>
										</div>
									</div>
								</form>
